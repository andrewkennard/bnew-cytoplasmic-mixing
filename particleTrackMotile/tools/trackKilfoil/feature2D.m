function [r,image] = feature2D(img,lambda,w,masscut,Imin,field,filtertype)
...
% EFK 2013: also returns the image post-bandpass filter 
...
% EFK: 
%filterType = 1 Gaussian filter of width w, sigma=w/2
% filterType=0 standard bandpass filter

if nargin < 7, filtertype = 'gauss'; end
